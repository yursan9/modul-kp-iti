...
\item Dalam praktikum ini peserta harus memperhatikan hal-hal sebagai berikut:
  ...
  \item Tas, buku, \eng{flash disk}, dll harus diletakkan pada tempat yang telah disediakan \emph{kecuali Buku Petunjuk Praktikum}.
  \item Peserta harus berpakaian rapih dan tidak diperkenankan memakai sandal.
  \item Ruangan praktikum merupakan ruangan ber-\eng{AC}. Di mana tidak seorang pun diperkenankan untuk merokok, membawa makanan, dan minuman.
  ...
  \item Praktikan dilarang mengganti atau mengubah perangkat lunak (\eng{Software}) atau kata sandi yang sudah ada.
